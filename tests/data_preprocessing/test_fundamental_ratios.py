...
from src.data_preprocessing.fundamental_ratios import (
...
def test_collect_fundamental_ratios_combines_selected_ratios():
    toolkit = FakeToolkit()

    features = collect_fundamental_ratios(toolkit, trailing=4)
